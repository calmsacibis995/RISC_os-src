 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: rpc_prot.c,v 1.2.1.2 90/05/07 21:00:46 wje Exp $"
/*
 * @(#)rpc_prot.c 1.1 86/09/24 Copyr 1984 Sun Micro
 *
 * rpc_prot.c
 *
...
/*
* Original includes:
* ../h/param.h ../rpc/types.h ../rpc/xdr.h ../rpc/auth.h ../rpc/clnt.h
