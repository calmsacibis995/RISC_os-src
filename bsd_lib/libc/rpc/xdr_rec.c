 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: xdr_rec.c,v 1.3.1.2 90/05/07 21:04:31 wje Exp $"
/*
 * @(#)xdr_rec.c 1.3  88/07/27 4.0NFSSRC Copyr 1988 Sun Micro
 * @(#)xdr_rec.c 1.22 88/02/08 SMI
 *
	...
	int (*writeit)();  /* like write, but pass it a tcp_handle, not sock */
{
	...
	if (rstrm == NULL) {
#ifdef KERNEL
		log(BSD43_LOG_ERR, "xdrrec_create: out of memory\n");
#else
		syslog(LOG_ERR, "xdrrec_create: out of memory\n");
#endif
		/* 
