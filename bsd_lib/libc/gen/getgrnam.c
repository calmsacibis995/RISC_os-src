 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: getgrnam.c,v 1.3.1.4.1.2 90/08/08 21:38:25 alexp Exp $"
...
register char *name;
{
	register struct group *p;
        ...
        while ((vis_func = vis_nextserv(vis_func, VIS_GETGRBYNAME))
                != VIS_DONE) {
                p = (struct group *)((*vis_func)(VIS_GETGRBYNAME, name));
