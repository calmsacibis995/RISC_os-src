 ...
 * |-----------------------------------------------------------|
 */
/* $Header: inst.h,v 1.15.1.2 90/05/10 06:24:12 wje Exp $ */
 ...
 *
 * THESE WILL BE DELETED IN THE NEXT VERSION OF THIS FILE
 */
...
/* obsolete op definitions kept temporarily to build old executables
 *
 * THESE WILL BE DELETED IN THE NEXT VERSION OF THIS FILE
 *
 * NOTE: these constant values are outside the legal opcode range.
 */

#define ld_op		0x41
#define sd_op		0x42
#define spim_op		0x43
#define spimi_op	0x44
