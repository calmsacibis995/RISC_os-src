 ...
 * |-----------------------------------------------------------|
 */
/* $Header: stream.h,v 1.13.1.3.2.1.1.2 90/11/15 11:37:00 beacker Exp $ */
...
#ifdef mips				/* Clover has everything */
#define NUSTRM 1			/* but configuration facilities */
#endif
...
#define STFIOASYNC 0200000		/* do BSD-style SIGIO	*/
#define STFJOBCTRL 0400000		/* do job control	*/
#define STFTOSTOP 01000000		/* do job control on output */
#define STFPENDIN 02000000		/* retype input on next read	*/
#define STFOPENWAIT 04000000		/* hold non-O_NDELAY opens while */
					/* this flag is set		 */
...
#define M_RETYPE	077		/* retype input			*/
...
#define M_CLRERROR	0213		/* clear error condition */
...
#define SO_JOBCTRL     0400		/* mark this to allow job control */
#define SO_TOSTOP     01000		/* mark this for output suspend */
#define SO_PENDIN     02000		/* mark this for input retype   */
					/* on next read			*/
#define SO_OPENWAIT   04000		/* hold completed opens which	*/
					/* do not have O_NDELAY set while */
					/* this option is set		*/

#define SO_NOT		0x8000		/* reset bit flags selected 	*/
					/* (such as SO_ISTTY or SO_JOBCTRL) */
...
extern int   sefree();
#ifdef KERNEL
extern void queuerun_block();
extern void queuerun_unblock();
#endif KERNEL
