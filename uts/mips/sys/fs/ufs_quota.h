 ...
 * |-----------------------------------------------------------|
 */
/* $Header: ufs_quota.h,v 1.3.1.3 90/05/10 06:19:44 wje Exp $ */

/*	@(#)quota.h	2.1 88/05/20 4.0NFSSRC SMI	*/
...
#ifndef _SYS_FS_UFS_QUOTA_
#define _SYS_FS_UFS_QUOTA_	1
...
#define MAX_BQ_WARN	3
#define MAX_FQ_WARN	3
#endif
...
struct	dqblk {
	...
	u_char  dqb_fwarn;	/* warnings left about excessive file use */
#endif
...
#define dq_fwarn	dq_dqb.dqb_fwarn
#endif
...
#if defined(RISCOS) && defined(TAHOE_QUOTA)
#define Q_DOWARN	7	/* warn user of over-limit usages */
#endif
...
extern struct dquot  dqfreelist;
typedef struct dquot *DQptr;
#endif /* RISCOS */

#endif _SYS_FS_UFS_QUOTA_
