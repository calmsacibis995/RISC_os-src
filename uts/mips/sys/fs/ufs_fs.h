 ...
 * |-----------------------------------------------------------|
 */
/* $Header: ufs_fs.h,v 1.2.1.2 90/05/10 06:19:16 wje Exp $ */
 ...
 */
 /* @(#)fs.h 2.1 88/05/20 4.0NFSSRC SMI */
 /* @(#)fs.h 7.1 06/04/86 UCB */

#ifndef _SYS_FS_UFS_FS_
#define _SYS_FS_UFS_FS_ 1
 ...
 */
#define UFS_CLEAN	0x01	/* set=clean, clear=dirty */
#define UFS_MOUNT	0x02	/* set on mount(), cleared on umounted */
#endif /* RISCOS */
