 ...
 * |-----------------------------------------------------------|
 */
/* $Header: firmware.h,v 1.9.4.2 90/05/10 06:13:21 wje Exp $ */

#ifndef	_SYS_FIRMWARE_
#define	_SYS_FIRMWARE_	1
...
/*
 * misc. defines of interest to standalones and kernels
 */
 ...
 *		^
 *		|
 * 0x00014000	0xa0014000 upward	standalone program text, data, and bss
 *					(kernel is loaded here, also)
 *
 * 0x00013fff	0xa0013fff downward	dbgmon stack
 *		|
 *		V
 *
 *		^
 *		|
 * 0x00008000	0xa0008000 upward	dbgmon text, data, and bss
 *
 * 0x00007fff	0xa0007fff downward	prom monitor stack
 *		|
 *		V
 *
 *		^
...
/*
 * PROM_NV_GET, PROM_NV_SET are two routines that will get/set information
 * in the NVRAM.  Both of these routines take indexs as opposed to
 * addresses to guarantee that the kernel does not require changes when
 * new versions of proms come out
 */
#define PROM_NV_GET	PROM_ENTRY(53)
#define PROM_NV_SET	PROM_ENTRY(54)

#endif	_SYS_FIRMWARE_
