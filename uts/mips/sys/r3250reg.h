 ...
 * |-----------------------------------------------------------|
 */
/* $Header: r3250reg.h,v 1.2.4.2.1.1.1.2 90/10/26 16:14:03 beacker Exp $ */
...
#define TYPE_R3264      2	/* type for the new boards */
#define TYPE_R3268	2	/*          "              */
...
#define SIZE_64MEG	0x30    /* 64M board. 1/2 pop */
#define SIZE_128MEG     0x40	/* 128M board */

#define UNUSED_BITS_MASK 0xfafffffa
...
#define	BANK_SHIFT	4	/* shift needed to print bank decode	*/
