 ...
 * |-----------------------------------------------------------|
 */
/* $Header: vnode.h,v 1.4.1.5.1.3 90/07/12 10:46:40 hawkes Exp $ */
#ifndef _SYS_VNODE_
#define _SYS_VNODE_ 1
...
struct vnode {
	...
	u_short		v_dnlcref;		/* #dnlc references to this */
						/* vnode (used for debugging) */
	caddr_t		v_data;			/* private data for fs */
	caddr_t         v_filocks;		/* list of file locks */
};
...
#define VHASMAP	      0x1000	/* "ALLOCMAP has been called" on this vnode */
/*
...
struct vattr {
	...
	int		va_fmode;	/* file mode for I/O */
};
...
#if RISCOS
/* The next two routines do not exist, and are not needed in a uniprocessor
 * NFS4.0 system.
 */
#define plock(ip)
#define prele(ip)
