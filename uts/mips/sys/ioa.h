 ...
 * |-----------------------------------------------------------|
 */
/* $Header: ioa.h,v 1.4.1.2.1.3 90/08/08 18:01:12 hawkes Exp $ */
...
#define GBA_OP_ERR_ADDR 0xE00
#define GBA_VME_ERR_ADDR 0xF00
...
typedef struct gba_misc_ctl_type {
    ...
    /******************************************************************
     * Address of error if error occurs on miss, prefetch, etc.
     ******************************************************************/
    unsigned long		gba_op_error_addr; 
    unsigned long reserved14[63];
    /******************************************************************
     * VME bus address when VME BERR occurs
     ******************************************************************/
    unsigned long		vme_error_addr;
