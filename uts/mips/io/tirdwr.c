 ...
 * |-----------------------------------------------------------|
 */
#ident "$Header: tirdwr.c,v 1.1.1.1.1.1.1.1 90/10/02 18:24:20 beacker Exp $"
...
static struct qinit tirdwrrinit =
 {tirdwrrput, NULL, tirdwropen, tirdwrclose, nulldev, &tirdwr_info, NULL};

static struct qinit tirdwrwinit =
 {tirdwrwput, NULL, tirdwropen, tirdwrclose, nulldev, &tirdwr_info, NULL};
