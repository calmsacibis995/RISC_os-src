 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: timod.c,v 1.1.1.1.1.1.1.1 90/10/02 18:23:46 beacker Exp $"
...
/*
 * ident "@(#)kern-port:io/timod.c 10.5"
 *
...
#include "sys/timodprv.h"   /* Private/internal data structure definitions */

/* stream data structure definitions */
int timodopen(), timodclose(), timodrput(), timodwput();

static struct module_info timod_info =
 {TIMOD_ID, "timod", 0, INFPSZ, 4096, 1024};

static struct qinit timodrinit =
 {timodrput, NULL, timodopen, timodclose, nulldev, &timod_info, NULL};

static struct qinit timodwinit =
 {timodwput, NULL, timodopen, timodclose, nulldev, &timod_info, NULL};
...
char ti_statetbl[TE_NOEVENTS][TS_NOSTATES] = { /* STATES */
