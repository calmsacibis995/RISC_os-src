 ...
 * |-----------------------------------------------------------|
 */
/* $Header: if_enp.h,v 1.5.4.2 90/05/10 04:22:24 wje Exp $ */

#ifndef	_BSD_MIPS_IF_ENP_
#define	_BSD_MIPS_IF_ENP_	1
...
#define	ENPDEVICE	volatile struct enpdevice
