 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: uipc_socket2.c,v 1.2.1.6 90/05/10 20:30:43 wje Exp $"
/*
 * Copyright (c) 1982, 1986 Regents of the University of California.
 * All rights reserved.  The Berkeley software License Agreement
 * specifies the terms and conditions for redistribution.
 *
 * @(#)uipc_socket2.c 2.1 88/05/18 4.0NFSSRC SMI
 * @(#)uipc_socket2.c 7.1 86/06/05 UCB
 */

/* originally included  param.h systm.h user.h proc.h file.h
 * buf.h mbuf.h protosw.h socket.h socketvar.h
 */
...
int nfs_wakeup_one_nfsd = 0;		/* Optimized wakeup for nfs daemons */
	...
	struct sockbuf *sb;
{
	sb->sb_flags |= SB_WAIT;
#ifdef RISCOS
	return (sleep((caddr_t)&sb->sb_cc, (PZERO+1)|PCATCH));
#else
