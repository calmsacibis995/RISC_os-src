/* $Header: sys_socket.c,v 1.21.1.1 89/11/28 10:28:02 wje Exp $ */
/* --------------------------------------------------- */
 ...
 *
 * @(#)sys_socket.c 2.1 88/05/18 4.0NFSSRC SMI
 * @(#)sys_socket.c 7.1 86/06/05 UCB
 */

/* originally included  param.h systm.h user.h file.h mbuf.h protosw.h
 * socket.h socketvar.h ioctl.h uio.h stat.h ../net/if.h ../net/route.h
 */
