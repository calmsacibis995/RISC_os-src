 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: uipc_syscalls.c,v 1.2.1.3 90/05/10 04:35:19 wje Exp $"
/*
 * Copyright (c) 1982, 1986 Regents of the University of California.
 * All rights reserved.  The Berkeley software License Agreement
 * specifies the terms and conditions for redistribution.
 *
 * @(#)uipc_syscalls.c 2.2 88/05/25 4.0NFSSRC SMI
 * @(#)uipc_syscalls.c 7.1 86/06/05 UCB
 */

/* originally included  param.h systm.h user.h proc.h file.h vnode.h
 * buf.h mbuf.h protosw.h socket.h socketvar.h uio.h
 */
...
#undef r_val2
#define r_val2	r_reg.R_val2
#define copyin	bsd_copyin
#define copyout	bsd_copyout
#endif
