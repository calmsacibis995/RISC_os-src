 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: udp_usrreq.c,v 1.9.1.2 90/05/10 04:31:59 wje Exp $"

/*
 * $Header: udp_usrreq.c,v 1.9.1.2 90/05/10 04:31:59 wje Exp $
 */
/*
...
#ifdef sgi
int	udp_sendspace = 32768;		/* really max datagram size */
int	udp_recvspace = 32768;
#else
