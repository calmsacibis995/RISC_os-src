 ...
 * |-----------------------------------------------------------|
 */
/* $Header: wait.h,v 1.7.4.2 90/05/10 04:38:43 wje Exp $ */

#ifndef	_BSD_SYS_WAIT_
#define	_BSD_SYS_WAIT_	1
