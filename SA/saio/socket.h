#ident "$Header: socket.h,v 1.2 90/01/16 17:58:53 huang Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright$ */
...
#ifdef PROM
#define	NSO_TABLE	2		/* only 2 ethernet connections */
#else
#define	NSO_TABLE	5
#endif
...
extern struct so_table *_get_socket();
extern struct so_table *_find_socket();
