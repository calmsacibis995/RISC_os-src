#ident "$Header: mips_3030dev.c,v 1.7 90/03/12 18:21:41 chungc Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright: |
 * |-----------------------------------------------------------|
...
**	2. review and update all devices and table for r3030 board.
...
/*
 * saio/device/mips_3030dev.c (MIPS version)
...
extern int _videoinit(), _videoopen(), _videostrategy(), _videoioctl();
...
struct device_table r3030_device_table[] = {
	...
	{
		"video",	_videoinit,	_videoopen,
		_videostrategy, _nulldev,	_videoioctl,
		DTTYPE_CHAR|DTTYPE_CONS,
		DTFS_NONE,	"video console"
	},
	{
	...
	/* nfs requires BSD network code */
	{
		"nfs",		_lainit,	_laopen,
		_lastrategy,	_laclose,	_laioctl,
		DTTYPE_CHAR,
		DTFS_NFS,	"Ethernet with RARP/TFTP protocols"
	},
	{
