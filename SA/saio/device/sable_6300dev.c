#ident "$Header: sable_6300dev.c,v 1.5 90/01/16 13:49:57 huang Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright$ */

/*
 * saio/device/sable_6300dev.c (SABLE version)
 * This file contains devices that are used by r6300 hardware.
 */
...
struct device_table r6300_device_table[] = {
	{
		"ioa",		_ioainit_all,	_nulldev,
		_nulldev,	_nulldev,	_nulldev,
		DTTYPE_CHAR|DTTYPE_BLOCK,
		DTFS_NONE,	"R6360 I/O Adapter"
	},
	{
