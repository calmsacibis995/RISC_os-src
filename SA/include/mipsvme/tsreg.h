#ident "$Header: tsreg.h,v 1.2 90/01/23 13:29:56 huang Exp $"
/* $Copyright$ */
...
#define	TSSR_RESET	0x8000	/* Subsystem Clear */
...
#define	TS_RBP	0000400		/* read bus parity error */
...
#define	TS_HSS	0100000		/* high speed status */
#define	TS_RCX	0040000		/* retry count exceeded */
#define TS_WRC	0000377		/* write retry count */
...
#define	c_repcnt c_loba		/* repeat count on position commands */
...
#define TS_SWB		0010000		/* don't swap bytes */
...
#define TS_RET		0000013		/* ISI QIC: retention command */
...
#define TS_RAW	0x08		/* enable non-block mode */
#define TS_Q11	0x04		/* operate in QIC-11 mode */
#define TS_FMT	0x02		/* enable set format command */

/* extended characteristics */

#define TS_XRL	0170000		/* extended inter-record gap retries */
#define TS_NRL	0007400		/* non-extended inter-record gap retries */
#define TS_RTY	0200		/* custom retry algorithm */
#define TS_LGP	0100		/* long gap &/or read threshold 2 */
#define TS_HSP	0040		/* high speed select */
#define	TS_RDB	0020		/* read buffering enable */
#define TS_WRB	0010		/* write buffering enable */
#define TS_SEL	0007		/* unit select */
