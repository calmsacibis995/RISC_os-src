#ident "$Header: mem_board.h,v 1.5 90/10/15 11:44:50 lian Exp $"
/* $Copyright$ */
...
/*
 * M2000/Genesis Memory Board Defines
 */
#define BRDTYPE_R3250	0x01		/* M2000/RC3260 mem board (1MB DRAM) */
#define BRDTYPE_R3260	0x02		/* Genesis mem board (4MB DRAM) */

#define BRDSIZE_16MEG	0x10		/* 16 MBytes mem board (R3251) */
#define BRDSIZE_32MEG	0x20		/* 32 Mbytes mem board (R3250) */
#define BRDSIZE_64MEG	0x30		/* 64 Mbytes mem board (R3264) */
#define BRDSIZE_128MEG	0x40		/* 128 Mbytes mem board  (R3268) */
...
#define	MEM_PROMID	0x80		/* base of id prom m2000 only */
#define	MBOXMEM_PROMID	0x200		/* base of id prom m500,800,1000 only */
#define MEM_BRDTYPE	MEM_PROMID	/* mem board type (lower byte) */
#define MEM_BRDSIZE	(MEM_PROMID+2)	/* mem board size (lower byte) */

/*
 * Offsets within id prom
 */
#define	ID_DRAMTYPE	0x2e		/* M->1MB, m->1MB half-pop, K->256K */
