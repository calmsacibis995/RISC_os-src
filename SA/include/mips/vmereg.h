#ident "$Header: vmereg.h,v 1.5 90/05/23 14:27:18 huang Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright$ */
...
#define	VME_IMR_RB3125	0x1e020002	/* interrupt mask for genesis*/
#define	VME_ISR		0x1e020007	/* interrupt status */
#define VME_ISR_RB3125	0x1e020006	/* interrupt status for genesis*/
#define	VME_IACK	0x1df00002	/* interrupt acknowledge */
#define VME_ISR_MSK_RB3125 0x1fff	/* mask off meaningless bits */

#define	NVMEVEC		1000	/* size of vmevec_tbl, WAG for now */

/* Interrupt Mask register definitions */

#define IMR_MIPSINT	1
#define IMR_DMAERRINTB	(1 << 8)
#define IMR_ZEROHALFB	(1 << 9)
#define IMR_BUFERROR	(1 << 10)
#define IMR_LNCINTB	(1 << 11)
#define IMR_SCSIINTB	(1 << 12)
#define ISR_DMAERRINTB	IMR_DMAERRINTB
#define ISR_ZEROHALFB	IMR_ZEROHALFB
#define ISR_BUFERROR	IMR_BUFERROR
#define ISR_LNCINTB	IMR_LNCINTB
#define ISR_SCSIINTB	IMR_SCSIINTB
