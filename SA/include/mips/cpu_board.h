/* $Header: cpu_board.h,v 1.35 90/10/16 14:23:19 chungc Exp $ */
/* $Copyright: |
 * |-----------------------------------------------------------|
 ...
 *	M2000  		R3200 board
 *	Excalibur	R6300 board (CPU)
 *	M12		I2000 board
 *	Excalibur	R6350 board (MEMORY)
 *	Excalibur	R6360 board (IOA)
 *	M180		R2400 board
...
#define IDPROM_R6300	0x1e00f804	/* IDPROM on Excalibur series */
...
#define BRDTYPE_R6300	6		/* Excalibur cpu board */
 ...
 */
#define BRDTYPE_R6350	100		/* Excalibur memory board */
#define BRDTYPE_R6360	101		/* Excalibur IOA board */
...
#define IS_COMMON_SCSI	(IS_R2400 || IS_R3030 || IS_RB3125)
#ifdef SABLE
#define IS_SABLE (1)
#else
#define IS_SABLE (0)
...
#define	LED_REG_R6300	0x1e02e003	/* LED register on Excalibur series */
...
#define DUART0_BASE_R6300	0x1e02e203	/* Duart 0 base on Excalibur */
...
#define TODC_CLOCK_ADDR_R6300	0x1e02c000	/* MK48T02 on Excalibur */
...
/*
 * This next section will be Intrepid only information.
 *
 * NOTE: M2000 may eventually contain a LANCE chip, and should end up
 *       at the same address as the LANCE on Intrepid.  Find out!
 *
 */
