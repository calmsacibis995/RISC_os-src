#ident "$Header: param.h,v 1.6 90/01/23 13:47:05 huang Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright$ */
...
#ifdef mips
#define	dkunit(bp)	(minor((bp)->b_dev) >> 4)
#else
...
/*
 * C_SHARED macro for gp reasons
 */

#define C_SHARED(type,variable)		extern type variable/**/[]
