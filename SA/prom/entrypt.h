#ident "$Header: entrypt.h,v 1.6 90/10/15 16:45:49 lian Exp $"
/*	%Q%	%I%	%M%	*/
/* $Copyright$ */
...
/*
 * Entry point to execute a warm reset on the M2000
 */
#define PROM_WARM	PROM_ENTRY(55)
...
/*
 * Entry point to the diags monitor. Returns if it is not found or machine type
 * mismatch.
 */
#define PROM_DIAGMON	PROM_ENTRY(56)
