#ident "$Header: pon_chain1.c,v 1.7.5.1 90/07/18 14:30:19 huang Exp $"
/* $Copyright: |
 * |-----------------------------------------------------------|
...

{
	...
	pon_set_leds(PON_CHAIN1);
	pon_puts("UDC Channel 1 Chain Test...");
...
/* Check registers */
	...
	if (udc->base != pattern) {
#ifdef	DEBUG
		pon_puts("FAILED UDC Channel 1 Current Address Register High\n\r");
#endif	DEBUG
		goto failed;
	}
...
#ifdef	DEBUG
		pon_puts("FAILED UDC Channel 1 Current Address Register Low\n\r");
#endif	DEBUG
		goto failed;
	}
...
#ifdef	DEBUG
		pon_puts("FAILED UDC Channel 1 Current Operation Count Register\n\r");
#endif	DEBUG
		goto failed;
	}
...
#ifdef	DEBUG
		pon_puts("FAILED UDC Channel 1 Channel Mode Register High\n\r");
#endif	DEBUG
		goto failed;
	}
	...
	if (udc->base != 0) {
#ifdef	DEBUG
		pon_puts("FAILED UDC Channel 1 Mode Register Low\n\r");
#endif	DEBUG
		goto failed;
	}
