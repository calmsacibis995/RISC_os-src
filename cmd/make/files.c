 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: files.c,v 1.4.2.2 90/05/09 16:44:11 wje Exp $"
/*
 ...
 *		rules.  What changed for this file was the call to findfl()
 *		now has two arguments. The second argument was added to
 *		findfl() which is the macro name with the path information.
 */
