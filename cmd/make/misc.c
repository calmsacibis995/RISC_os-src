 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: misc.c,v 1.8.2.2 90/05/09 16:45:02 wje Exp $"
/*
 ...
 *		rules.  What changed for this file was a second argument
 *		was added to findfl() which is the macro name with the
 *		path information.
 */
 ...
 *	mh	1/2/86	make findfl subst the varptr string.
 */
...
/*
 *	change s.xx to xx or /x/y/s.z to /x/y/z
 */
CHARSTAR
untrysccs(str)
register CHARSTAR str;
...
CHARSTAR rlse;
{
	...
	register CHARSTAR pr1 = NULL;
	register CHARSTAR pr2 = NULL;
	char gbuf[128];
	char sfile[128];
	int retval;
	GOTF gf;
