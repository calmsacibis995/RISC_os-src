 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: deroff.c,v 1.6.2.2 90/05/09 15:41:02 wje Exp $"
	...
	for (;;) {
		if (c == '\\') {
			*lp = ' ';
			backsl ();
			if (c == '%')
				lp--;/* no blank for hyphenation char */
		}
		if (c == '\n')
			break;
		if (intable && c == 'T') {
...
comx: 
	...
	if (c1 == 'E' && c2 == 'Q' && filesp == files)
		...
		if (c1 == 'T' && (c2 == 'S' || c2 == 'C' || c2 == '&') && filesp == files) {
			if (msflag) {
				stbl ();
			}
			else
			...
			if (c1 == 'T' && c2 == 'E')
				...
				if (!inmacro && c1 == 'd' && c2 == 'e')
					macro ();
				else
					if (!inmacro && c1 == 'i' && c2 == 'g')
						macro ();
					else
						if (!inmacro && c1 == 'a' && c2 == 'm')
							macro ();
						else
							if (c1 == 's' && c2 == 'o')
								if (iflag) {
