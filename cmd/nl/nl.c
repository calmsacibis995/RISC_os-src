 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: nl.c,v 1.6.2.2 90/05/09 18:13:58 wje Exp $"
...
int c;
{
	fprintf(stderr, "Illegal Regular Expression (error code %d)\n", c);
	exit(1);
}
...
usage()
{
	fprintf(stderr, "usage: nl [-htype] [-btype] [-ftype] [-vstart#] [-iincr] [-p]\n          [-lnum] [-ssep] [-wwidth] [-nformat] [-ddelim] [file]\n");
}
