 ...
 * |-----------------------------------------------------------|
 */
/* $Header: acctdef.h,v 1.1.2.4 90/05/09 17:19:43 wje Locked $ */
 ...
 */
#define A_SSIZE	3001	/* max number of sessions in 1 acct run */
#define A_TSIZE	1024	/* max number of line names in 1 acct run */
...
#endif
#if mips
#define KCORE(clicks)  ((double) ((clicks*NBPC)/1024))
#endif
