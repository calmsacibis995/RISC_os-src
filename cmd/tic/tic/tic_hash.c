 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: tic_hash.c,v 1.2.1.2 90/05/09 19:41:01 wje Exp $"
 ...
 *
 *  $Log:	tic_hash.c,v $
 * Revision 1.2.1.2  90/05/09  19:41:01  wje
 * add restricted rights legend
 * 
 * Revision 1.2.1.1  89/11/27  04:41:54  wje
 * Branch RISCOS_4_50_FIXES off of trunk.
 * 
 * Revision 1.2  89/09/08  09:52:22  vicki
