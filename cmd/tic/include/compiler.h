 ...
 * |-----------------------------------------------------------|
 */
/* $Header: compiler.h,v 1.1.1.2 90/05/09 19:39:22 wje Exp $ */
...
/* ident	"@(#)curses:screen/compiler.h	1.2" */
/*********************************************************************
*                         COPYRIGHT NOTICE                           *
**********************************************************************
 ...
 *
 *  $Log:	compiler.h,v $
 * Revision 1.1.1.2  90/05/09  19:39:22  wje
 * add restricted rights legend
 * 
 * Revision 1.1.1.1  89/11/29  17:05:03  wje
