...
# ifndef SMTP
# ifndef lint
static char sccsid[] = 	"@(#)usersmtp.c	1.2 88/05/02 4.0NFSSRC SMI (no SMTP)"; /* from UCB 5.7 4/2/86 */
						/* @(#) from SUN 1.23 */
# endif not lint
# else SMTP

# ifndef lint
static char sccsid[] = 	"@(#)usersmtp.c	1.2 88/05/02 4.0NFSSRC SMI (with SMTP)"; /* from UCB 5.7 4/2/86 */
						/* @(#) from SUN 1.23 */
# endif not lint
	...
	register ENVELOPE *e;
{
	...
	*/
	...
	putline("\n", SmtpOut, m);
	(*e->e_putbody)(SmtpOut, m, CurEnv, "user smtp");
