#ifndef lint
# ifdef DBM
static char sccsid[] = 	"@(#)alias.c	1.4 88/05/26 4.0NFSSRC SMI (with DBM)"; /* from UCB 5.13 4/17/86 */
# else DBM
static char sccsid[] = 	"@(#)alias.c	1.4 88/05/26 4.0NFSSRC SMI (without DBM)"; /* from UCB 5.13 4/17/86 */
# endif DBM
#endif not lint
...
SCCSID(@(#)alias.c 1.17 87/09/03 SMI); /* from UCB 5.13 4/17/86 */
...
**		to lower case before doing the YP lookup, and then converting
...
# endif DEBUG
	strcpy(lowered, string);
	s = stab(lowered, ST_CLASS, ST_ENTER);
