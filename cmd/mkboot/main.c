 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: main.c,v 1.6.2.2 90/05/09 16:47:03 wje Exp $"
...
#else	mips
	/*
	 * Since the "optional header" isn't optional for mips
	 * object files, we have to place the mkboot-specific
	 * data at the end of the file.
	 * Copy the optional header to the new object file.
	 */
	if ( myread(fdin,(char*)&aouthdr,AOUTHSZ,file) )
		goto bad;

	if ( mywrite(fdout,(char*)&aouthdr,AOUTHSZ,tempname) )
		goto bad;
#endif	mips
