 ...
 * |-----------------------------------------------------------|
 */
/* $Header: awk.h,v 1.7.2.2 90/05/09 15:11:51 wje Exp $ */
...
uchar	*tostring(), *tokname(), *malloc(), *calloc();
...
#define MAKE_SVAL(s)	((s) ? (s) : "")	/* Prevent NULL sval */
...
#define isvalue(n)	((n) && (n)->ntype == NVALUE)
