 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: miv4.c,v 1.1.1.2 90/05/09 17:30:42 wje Exp $"

/*
 *	$Header: miv4.c,v 1.1.1.2 90/05/09 17:30:42 wje Exp $
 *	Author: J. Davin
...
MisStatusType		mivTicksRW (name, namelen, address)
...
MisStatusType		mivTicksRO (name, namelen, address)
