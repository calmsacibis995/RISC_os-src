 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: miv5.c,v 1.1.1.2 90/05/09 17:30:48 wje Exp $"

/*
 *	$Header: miv5.c,v 1.1.1.2 90/05/09 17:30:48 wje Exp $
 *	Author: J. Davin
...
MisStatusType		mivStringRW (name, namelen, address)
...
MisStatusType		mivStringRO (name, namelen, address)
