 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: miv1.c,v 1.1.1.2 90/05/09 17:29:56 wje Exp $"

/*
 *	$Header: miv1.c,v 1.1.1.2 90/05/09 17:29:56 wje Exp $
 *	Author: J. Davin
...

{
	if ((namelen != (MixLengthType) 1) ||
		...
		return (asnUnsl (asnClassUniversal, (AsnTagType) 2,
			*((CUnslPtrType) mix)));
	}
}
...
MisStatusType		mivUnslRW (name, namelen, address)
...
MisStatusType		mivUnslRO (name, namelen, address)
