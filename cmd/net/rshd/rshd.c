 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: rshd.c,v 1.12.2.2 90/05/09 17:21:29 wje Exp $"
...
#ifndef lint
static char sccsid[] = "@(#)rshd.c	5.11 (Berkeley) 4/18/88";
#endif not lint
...
char	tz[32] = "TZ=";
char	*envinit[] =
	{homedir, shell, "PATH=:/usr/ucb:/bin:/usr/bin", username, logname, tz, 0};
#define TZ_INDEX 5
extern char *getenv();
#else
char	*envinit[] =
