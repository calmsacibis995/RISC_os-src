 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ext.c,v 1.2.1.2 90/05/09 16:59:05 wje Exp $"
/*
...
#ifndef	lint
static char *rcsid = "$Header: ext.c,v 1.2.1.2 90/05/09 16:59:05 wje Exp $";
#endif	not lint
...
long gatedtime;			/* time of day in secs of current interrupt */
