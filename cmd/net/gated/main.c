 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: main.c,v 1.3.1.2 90/05/09 17:00:48 wje Exp $"
/*
...
#ifndef	lint
static char *rcsid = "$Header: main.c,v 1.3.1.2 90/05/09 17:00:48 wje Exp $";
#endif	not lint
	...
	int sock, protocol;
{
  ...
  getod();			/* current time */
#ifdef RISCOS
  if (protocol == IPPROTO_SNMP)
	count = read (sock, packet, sizeof (packet));
  else
#endif RISCOS
