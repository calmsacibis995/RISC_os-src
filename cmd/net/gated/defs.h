 ...
 * |-----------------------------------------------------------|
 */
/* $Header: defs.h,v 1.2.1.2 90/05/09 16:58:35 wje Exp $ */
/*
...
#if	defined(UTX32_1_X) || defined(UTX32_2_X) || defined(sun) || defined(RT43) || defined(RISCOS)
...
extern	long	gatedtime;	/* time of day in seconds of current interrupt */
