 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: messages.c,v 1.5.2.3 90/05/09 15:37:30 wje Exp $"

/* $Log:	messages.c,v $
 * Revision 1.5.2.3  90/05/09  15:37:30  wje
 * add restricted rights legend
 * 
 * Revision 1.5.2.2  89/12/10  22:25:33  wje
 * add RID 1.6 to branch RISCOS_4_50_FIXES
 * 
 * Revision 1.6  89/12/10  18:42:10  jay
 * replaced with files from 2.0 C compiler's lint, modified to support cxref.
 * closes bugs 1373
 * 
 * Revision 2000.7  89/03/26  14:48:12  bettina
 * 2.0G
 * 
 * Revision 1040.6  88/09/29  15:53:00  bettina
 * bootstraped 1.40
 * 
 * Revision 1.2  87/12/09  11:41:45  gb
 * added $Log keyword
 *  */
...
/* [129] !01*/  "only \"volatile\" permitted",
/* [130] !02 */ "only unsigned char, short, int, and long bit fields supported, field treated as unsigned",/* werror */
/* [131]  */ "type too complicated, volatile ignored",	/* werror */
/* [132]  */ "illegal pointer assignment, cast to volatile required",/*uerror*/
/* [133]  */ "\"const\" is reserved for future use", /* uerror */
/* [134]  */ "varargs.h macros may be required if the address of the parameter is used to index thru a parameter list.",/*werror*/
/* [135]  */ "a %c was found, but '.' expected; an ellipsis was inserted",
/* [136]  */ "inconsistent prototypes for function %s", /* uerror */
/* [137]  */ "constraint checking not implemented for this style of prototype",
/* [138]  */ "argument type doesn't match prototype description", /* uerror */
/* [139]  */ "number of arguments doesn't agree with prototype description",
/*uerror*/
/* [140]  */ "number of dimensions between array argument and prototype disagree",/*uerror*/
/* [141]  */ "bounds of array argument and prototype disagree", /*uerror*/
/* [142]  */ "prototype and parameter declarations are inconsistent", /*uerror*/
/* [143]  */ "illegal use of void. void specifies that the function has no parameters", /*uerror*/
/* [144]  */ "function has a prototype, parameter declarations not allowed",
/*uerror*/
/* [145]  */ "illegal storage class, only register permitted", /*uerror*/
/* [146]  */ "Resulting pointer may not be valid if improperly aligned for the type pointed to",
/* [147]  */ "Switch expression must have integral type", /*uerror*/
/* [148]  */ "')' expected.", /*uerror*/
/* [149]  */ "'(' expected.", /*uerror*/
/* [150]  */ "pragma name expected.", /*uerror*/
/* [151]  */ "unsupported pragma. pragma ignored.", /*werror*/
/* [152]  */ "',' expected", /* uerror*/
};
#else
char	*msgtext[ NUMMSGS ] = {
