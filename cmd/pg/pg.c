 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: pg.c,v 1.8.2.2.1.1.1.2 90/10/05 16:26:09 beacker Exp $"
...
int             fnum = 0;       /* which file argument we're in */
		pipe_in = 0;	/* set when stdin is a pipe */
		out_is_tty = 0;	/* set if stdout is a tty */
