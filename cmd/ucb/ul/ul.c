 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ul.c,v 1.4.2.2 90/05/10 00:31:39 wje Exp $"

#ifndef lint
static char sccsid[] =	"@(#)ul.c	4.5 (Berkeley) 8/11/83";
/* $Source: /MIPSNET/dish/root/usr4/co-rel4.50/root/usr/src/cmd/ucb/ul/RCS/ul.c,v $ */
static	char	*Sccsid = "@(#)$Revision: 1.4.2.2 $";
/* $Date: 90/05/10 00:31:39 $ */
#endif
