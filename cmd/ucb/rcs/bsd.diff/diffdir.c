 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: diffdir.c,v 1.5.1.2 90/05/10 00:24:34 wje Exp $"
...
/* The check for 8-bit data will take care of this */
#ifdef CHECK_FOR_BINARY
