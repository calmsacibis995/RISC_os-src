 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ci.c,v 1.4.2.4.1.1.1.3 90/11/07 11:20:03 beacker Exp $"
...
char * argv[];
{
	...
	struct stat stb;         /* for checking for directories            */
 ...
 */
{
	...
	int cin;
        ...
        if (isatty(fileno(stdin))) {
               VOID fprintf(stdout, "enter log message for file %s:\n",
		   workfilename);
