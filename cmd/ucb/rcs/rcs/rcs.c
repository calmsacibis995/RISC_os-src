 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: rcs.c,v 1.3.2.2 90/05/10 00:27:47 wje Exp $"
...
char * argv[];
{
	...
	catchints();
        ...
        quietflag = false;
	branchflag = false;
        comdusge ="command format:\nrcs -i -alogins -Alogins -e[logins] -c[commentleader] -l[rev] -u[rev] -b -L -U -nname[:rev] -Nname[:rev] -orange -sstate[:rev] -t[textfile] file....";
