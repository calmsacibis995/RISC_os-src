 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: rcsfnms.c,v 1.4.2.3 90/05/10 00:22:45 wje Exp $"
 ...
 */
{
        ...
        if (pureRCSname!=RCS1) {
                ...
                VOID strcpy(subfilename,RCSDIR); strcat(subfilename,RCS1);
                opened=(
...
#ifdef mips
/*
 * We have rename() and can simulate getwd() with getcwd().
 */
