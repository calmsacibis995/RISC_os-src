 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: quot.c,v 1.2.1.2 90/05/09 18:21:49 wje Exp $"

/*
 * @(#)quot.c	1.2 88/03/15 4.0NFSSRC	from 4.11 (Berkeley) 85/09/09
 */
