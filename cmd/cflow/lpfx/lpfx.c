 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: lpfx.c,v 1.5.2.3 90/05/09 15:21:06 wje Exp $"
...
static char *types[] = {
	...
	"unsigned short", "unsigned int", "unsigned long","signed","VARARGS"};
