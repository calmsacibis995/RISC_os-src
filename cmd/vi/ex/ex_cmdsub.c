 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ex_cmdsub.c,v 1.9.1.2 90/05/10 00:48:47 wje Exp $"
...
badtags:
			...
			*lp++ = 0;
			 ...
			 * line) we get left in nomagic and wrapscan mode.
			 */
			value(vi_MAGIC) = 0;
			value(vi_WRAPSCAN) = 1;
			commands(1, 1);
