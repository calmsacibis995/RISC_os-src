 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: setkey.c,v 1.2.1.3 90/05/09 19:13:13 wje Exp $"

#ifndef lint
static char sccsid[] = 	"@(#)setkey.c	1.1 88/03/07 4.0NFSSRC Copyr 1988 Sun Micro";
#endif
...
#ifdef RISCOS
			syslog(LOG_ERR, "setkey: %s: ", ROOTKEY);
