 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: keyenvoy.c,v 1.2.1.3 90/05/09 19:13:00 wje Exp $"

#ifndef lint
static char sccsid[] = 	"@(#)keyenvoy.c	1.2 88/05/16 4.0NFSSRC Copyr 1988 Sun Micro";
#endif
...
callkeyserver(proc, xdr_args, args, xdr_rslt, rslt)
	u_long proc;
	bool_t (*xdr_args)();
	char *args;	/* was a void * */
	bool_t (*xdr_rslt)();
	char *rslt;	/* was a void * */
