 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: spray.c,v 1.6.1.2 90/05/09 19:27:39 wje Exp $"
#ifndef lint
		...
		if (argv[1][0] == '-') {
			switch(argv[1][1]) {
				case 'd':
					...
					{
					    fprintf(stderr,
				"spray: invalid argument for -d: %s\n",argv[2]);
					    exit(1);
					}
					argc--;
					argv++;
				...
				case 'c':
					...
					{
					    fprintf(stderr,
				"spray: invalid argument for -c: %s\n",argv[2]);
					    exit(1);
					}
					argc--;
					argv++;
				...
				case 'l':
					...
					{
					    fprintf(stderr,
				"spray: invalid argument for -l: %s\n",argv[2]);
					    exit(1);
					}
					argc--;
					argv++;
