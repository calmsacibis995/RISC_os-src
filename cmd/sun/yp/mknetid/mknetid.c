 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: mknetid.c,v 1.1.1.2 90/05/09 19:29:05 wje Exp $"
#ifndef lint
static char sccsid[] = 	"@(#)mknetid.c	1.1 88/03/07 4.0NFSSRC Copyr 1988 Sun Micro";
#endif
