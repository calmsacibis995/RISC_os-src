 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: lpadmin.c,v 1.5.2.2 90/05/09 16:31:26 wje Exp $"
...
usage()
{
	fprintf(stderr, "usages:\tlpadmin -pprinter [-vdevice] [-cclass] [-rclass]\n");
	fprintf(stderr, "\t     [-eprinter|-iinterface|-mmodel] [-h|-l]\n");
	fprintf(stderr, "\t\t-or-\n");
	fprintf(stderr, "\tlpadmin -d[destination]\n");
	fprintf(stderr, "\t\t-or-\n");
	fprintf(stderr, "\tlpadmin -xdestination\n");
	exit(2);
}
