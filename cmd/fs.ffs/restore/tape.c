 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: tape.c,v 1.5.1.3 90/05/09 16:00:30 wje Exp $"
...
setup()
{
	...
	if (vflag || command == 't') {
#if defined(RISCOS)
	  if (spcl.c_user_info_vers == RISCOS_MAGIC_VERSION) {
	  	printdumpinfo();
	  } else {	/* old tape w/o extensions */
