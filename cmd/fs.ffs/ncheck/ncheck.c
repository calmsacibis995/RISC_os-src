 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ncheck.c,v 1.6.1.2 90/05/09 15:58:05 wje Exp $"
 ...
 *
 *	@(#)ncheck.c	1.2 88/03/13 4.0NFSSRC; from	5.4 (Berkeley) 1/9/86
 */
...
usage()
{
	fprintf(stderr, "ncheck: usage: ncheck [-i numbers] [-m] [-a] [-s] filesystem ...\n");
}
#endif
