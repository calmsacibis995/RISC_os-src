 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: grep.c,v 1.8.1.2 90/05/09 16:07:40 wje Exp $"
...
#define ESIZE	256
#define	BLKSIZE	512		/* disk "block" size for -b option */

#undef BUFSIZ			/* eliminate a redefine warning */
#define	BUFSIZ		(NCARGS+1)	/* handle arg-list sized lines		*/
