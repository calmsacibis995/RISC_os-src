 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: io.c,v 1.1.2.2 90/05/10 03:05:24 wje Exp $"
...
/* VARARGS1 */
msg(fmt, arg1, arg2, arg3, arg4, arg5)
	char	*fmt;
{

    doadd(fmt, arg1, arg2, arg3, arg4, arg5);
    endmsg();
}
 ...
 */
/* VARARGS1 */
addmsg(fmt, arg1, arg2, arg3, arg4, arg5)
	char	*fmt;
{
    doadd(fmt, arg1, arg2, arg3, arg4, arg5);
}
...
va_dcl
{
    ...
    va_start(ap);
    args[0] = va_arg(ap, char *);
    args[1] = va_arg(ap, char *);
    args[2] = va_arg(ap, char *);
    args[3] = va_arg(ap, char *);
    args[4] = va_arg(ap, char *);
    va_end(ap);
