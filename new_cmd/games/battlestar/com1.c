 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: com1.c,v 1.1.2.2 90/05/10 02:58:25 wje Exp $"
...
news()
{
	...
	if (curtime > (rythmn + CYCLE)) {
		if (location == nightfile) {
			convert(TODAY);
			if (OUTSIDE && curtime - rythmn - CYCLE < 10) {
