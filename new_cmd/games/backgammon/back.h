 ...
 * |-----------------------------------------------------------|
 */
/* $Header: back.h,v 1.1.3.2 90/05/10 02:55:07 wje Exp $ */
...
/*
 * There is a message that is printed before the game starts. This message
 * is defined in message.c. If the macro PRINTMESSAGE is defined, the
 * message gets printed. Since the current message is so inane, the defaukt
 * is to turn it off.
 */

/* #define PRINTMESSAGE	1		/* print startup message */
