...
/* $Source: /usr4/co-rel4.50/root/usr/src/new_cmd/emacs/dist/src/RCS/xmenu.c,v $
 * $Author: wje $
 * $Locker:  $
 * $Header: xmenu.c,v 1.1.2.1 89/11/27 22:58:52 wje Exp $
 *
 */

#ifndef lint
static char *rcsid_GXMenu_c = "$Header: xmenu.c,v 1.1.2.1 89/11/27 22:58:52 wje Exp $";
#endif	lint
