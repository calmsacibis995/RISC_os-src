...
/*
 *	$Source: /usr4/co-rel4.50/root/usr/src/new_cmd/emacs/dist/src/RCS/x11term.c,v $
 *	$Author: wje $
 *	$Locker:  $
 *	$Header: x11term.c,v 1.1.2.1 89/11/27 22:58:20 wje Exp $
 */

#ifndef lint
static char *rcsid_xterm_c = "$Header: x11term.c,v 1.1.2.1 89/11/27 22:58:20 wje Exp $";
#endif	lint
