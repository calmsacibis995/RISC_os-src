...
/*
 *	$Source: /usr4/co-rel4.50/root/usr/src/new_cmd/emacs/dist/src/RCS/xterm.c,v $
 *	$Author: wje $
 *	$Locker:  $
 *	$Header: xterm.c,v 1.1.2.1 89/11/27 22:59:01 wje Exp $
 */

#ifndef lint
static char *rcsid_TrmXTERM_c = "$Header: xterm.c,v 1.1.2.1 89/11/27 22:59:01 wje Exp $";
#endif	lint
