/* $Header: search.c,v 1.1.1.1 89/11/28 01:08:27 wje Exp $
 *
 * $Log:	search.c,v $
 * Revision 1.1.1.1  89/11/28  01:08:27  wje
 * Branch RISCOS_4_50_FIXES off of trunk.
 * 
 * Revision 1.1  89/05/26  20:57:18  kris
 * Initial revision
 * 
...
char *addr;
{
    ...
    if (compex->expbuf && compex->expbuf[0] == CCHR && !compex->alternatives[1]) {
