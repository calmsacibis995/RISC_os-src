 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: init.c,v 1.1.1.3 90/05/28 17:58:02 wje Exp $"
/* $Header: init.c,v 1.1.1.3 90/05/28 17:58:02 wje Exp $
 *
 * $Log:	init.c,v $
 * Revision 1.1.1.3  90/05/28  17:58:02  wje
 * add restricted rights legend
 * 
 * Revision 1.1.1.2  90/05/28  17:35:34  wje
 * add RID 1.2 to branch RISCOS_4_50_FIXES
 * 
 * Revision 1.2  90/05/25  11:30:46  cleo
 * init.c needed to send a signal that rn would ignore as a way of testing
 * for the existence of a previous rn.  the problem is that SIGEMT and 
 * SIGXCPU are overloaded and we have a signal handler for SIGXCPU.
 * 
 * Revision 1.1  89/05/26  20:55:18  kris
 * Initial revision
 * 
