#ifndef lint
static char sccsid[] = "@(#)patch.c	5.7 (Berkeley) 3/29/86";
#endif not lint

/* patch - a program to apply diffs to original files
 *
 * $Header: patch.c,v 1.1.1.1 89/11/28 02:37:41 wje Exp $
 *
 ...
 *
 * $Log:	patch.c,v $
 * Revision 1.1.1.1  89/11/28  02:37:41  wje
 * Branch RISCOS_4_50_FIXES off of trunk.
 * 
 * Revision 1.1  89/05/24  20:59:22  kris
 * Initial revision
 * 
