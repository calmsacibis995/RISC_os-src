...
register int    use;
{
	...
	default: 
		...
		/* it is not entirely clear just exaclty what is
		 * being tested for here, but it doesn't
		 * seem like it is ever valid to delete
		 * the user's draft...just save what you can...
