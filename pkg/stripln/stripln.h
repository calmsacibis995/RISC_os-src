 ...
 * |-----------------------------------------------------------|
 */
/* $Header: stripln.h,v 1.1.2.2 90/05/10 04:05:15 wje Exp $ */
#ifdef MAIN
static char rcsm[]=MAKEID;
static char rcsh[]="$Header: stripln.h,v 1.1.2.2 90/05/10 04:05:15 wje Exp $";
#endif
...
GLOBAL (long rmtime);           /* time argument, if -t given */
