 ...
 * |-----------------------------------------------------------|
 */
/* $Header: mksizes.h,v 1.1.2.2 90/05/10 03:58:18 wje Exp $ */
#ifdef MAIN
static char rcsm[]=MAKEID;
static char rcsh[]="$Header: mksizes.h,v 1.1.2.2 90/05/10 03:58:18 wje Exp $";
#endif
...
#define NUIDDIR 100 /* number of uid's to index directly */
#define NUIDIND 256 /* number of uid's to index indirectly */

#define MAXGNAM 16  /* max length of group name */
#define NGIDDIR 100 /* number of gid's to map directly */
#define NGIDIND 256 /* number of gid's to map indirectly */

/* Maximum number of stamps allowed for this package */

#define MAXSTAMPS	512	/* massive overkill */
...
GLOBAL (long totalbytes);
GLOBAL (long totalinodes);
