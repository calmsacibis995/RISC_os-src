 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: start_col.c,v 1.2.1.2 90/05/10 02:23:29 wje Exp $"
...
/*
    SP->_pairs_tbl[0].foreground = 0;
    SP->_pairs_tbl[0].background = COLORS;
*/
