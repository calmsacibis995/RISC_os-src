 ...
 * |-----------------------------------------------------------|
 *  $ */
/* $Header: elf_mips.h,v 1.1.2.1.1.1 90/06/28 15:34:28 root Exp $ */
...
#define SHT_MIPS_CONFLICT	(SHT_LOPROC + 3)
#define SHT_MIPS_GPTAB		(SHT_LOPROC + 4)
#define SHT_MIPS_UCODE		(SHT_LOPROC + 5)
...
#endif				/* LANGUAGE_C || LANGUAGE_ASSEMBLY */
