 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ehash.c,v 1.1.1.2 90/05/07 19:28:25 wje Exp $"
...
char able();
extern struct dict able_d[];
char ace();
extern struct dict ace_d[];
char age();
extern struct dict age_d[];
char ance();
extern struct dict ance_d[];
char ant();
extern struct dict ant_d[];
char cal();
extern struct dict cal_d[];
char cle();
extern struct dict cle_d[];
char ee();
extern struct dict ee_d[];
char ence();
extern struct dict ence_d[];
char ess();
extern struct dict ess_d[];
char est();
extern struct dict est_d[];
char ful();
extern struct dict ful_d[];
char ible();
extern struct dict ible_d[];
char ic();
extern struct dict ic_d[];
char ice();
extern struct dict ice_d[];
char ion();
extern struct dict ion_d[];
char ional();
extern struct dict ional_d[];
char is();
extern struct dict is_d[];
char ish();
extern struct dict ish_d[];
char ist();
extern struct dict ist_d[];
char ite();
extern struct dict ite_d[];
char ive();
extern struct dict ive_d[];
char ize();
extern struct dict ize_d[];
char lar();
extern struct dict lar_d[];
char less();
extern struct dict less_d[];
char man();
extern struct dict man_d[];
char ment();
extern struct dict ment_d[];
char ness();
extern struct dict ness_d[];
char ous();
extern struct dict ous_d[];
char ship();
extern struct dict ship_d[];
char ss();
extern struct dict ss_d[];
char ure();
extern struct dict ure_d[];
char us();
extern struct dict us_d[];
char ing();
extern struct dict ing_d[];
char ed();
extern struct dict ed_d[];
struct fandd {
	char (*fun)();
	struct dict *yd;
} arr[] = {
