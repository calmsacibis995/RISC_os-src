 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: egrep.c,v 1.2.1.2 90/05/07 18:36:46 wje Exp $"

#ifndef lint
static char sccsid[] = "@(#)egrep.c	5.10 (Berkeley) 6/30/88";
#endif not lint
 ...
 */
#ifndef EGREPSTD
#define	EGREPSTD	"/usr/lib/grep_cmds/egrep"
#endif
#ifndef GREPSTD
#define	GREPSTD		"/usr/lib/grep_cmds/grep"
#endif
#ifndef FGREPSTD
#define	FGREPSTD	"/usr/lib/grep_cmds/fgrep"
#endif
