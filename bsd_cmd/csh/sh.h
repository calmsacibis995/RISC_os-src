 ...
 * |-----------------------------------------------------------|
 */
/* $Header: sh.h,v 1.2.1.2 90/05/07 18:16:12 wje Exp $ */
...
bool	fastlist;		/* don't stat files when listing */
#endif
#ifdef  TSH
bool	tsh_line_edit;		/* line editor on */
#endif
#if defined (FILEC) || defined (TSH)
#define PREPROCESS
#endif
...
#define	reset()		longjmp(reslab, 1) /* SVID says longjmp should use non-zero */
...
#define TIMEPR '@'			/* replaced by time in prompt */
