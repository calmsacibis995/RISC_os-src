 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: ptx.c,v 1.3.1.4 90/05/22 18:22:17 wje Exp $"

static char *sccsid = "@(#)ptx.c	4.3 (Berkeley) 12/2/87";
#
...
#include <ctype.h>
#include <signal.h>
#define DEFLTX "/bsd43/usr/lib/eign"
#define SORT "/bsd43/bin/sort"
#define TILDE 0177
#define	N 30
#define	MAX	N*BUFSIZ
#define LMAX	200
