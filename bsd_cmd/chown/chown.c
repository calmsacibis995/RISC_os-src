 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: chown.c,v 1.1.2.2 90/05/07 18:09:19 wje Exp $"
...
/*
 * Perror() used to just print the error message given by the errno, but
 * in the case of EPERM, "Not owner" is not appropriate. Thus, we print
 * "Not super-user", which tells the real story.
 */
